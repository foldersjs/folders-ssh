...
FoldersSsh.prototype.mkdir = function (path, cb) {

    var self = this;

    console.log("[folders-ssh mkdir] folders-ssh, mkdir ", path);
    ...
    conn.on('ready', function () {
        ...
        // Via SFTP
        console.log("[folders-ssh mkdir] begin to send mkdir request,");
        conn.sftp(function (err, sftp) {
            if (err) {
            ...
            console.log("[folders-ssh mkdir] begin conn sftp mkdir dir,");
